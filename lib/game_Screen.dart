  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Game Screen",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
      ),
      body: Column(
        children: [
          Expanded(
                      ...
                      if (snakePosition.contains(index)) {
                        return Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(4.0),
                            child: ColoredBox(
                              color: snakePosition.last == index ? Colors.black : Colors.red,
                            ),
                          ),
                        );
                      }
          ...
          Center(
            child: ElevatedButton(
              ...
              child: const Text('Start',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),),
            ),
          ),
